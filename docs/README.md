...
### Básica 
- [Project file structure](./RTA.0.Structure.md)
- [Experiment class description](./RTAutils.experiment.md)

### Adicional
- [Preprocessing notebook](./RTA.1.Preprocessing.md)
- [ML utils notebook](./RTA.2.ML_utils.md)
- [Data preparation notebook](./RTA.3.Data_preparation.md)
